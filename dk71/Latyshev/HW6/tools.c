...

{
    ...
    char Pivot = NodeAtIndex(thelist, last)->value;
...

	{
		...
		do theLeft++; while (theLeft < last && NodeAtIndex(thelist, theLeft)->value < Pivot);



        do theRight--; while (NodeAtIndex(thelist, theRight)->value > Pivot);
