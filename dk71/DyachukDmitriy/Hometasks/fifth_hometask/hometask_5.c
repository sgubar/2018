...
void write_Circle_to_JSON(FILE *current_File, Circle *current_Circle)
{
    ...
    fprintf(current_File, ", \n\t\t\t\"Area of Circle\" : %f\n\t}", calculating_Length_and_Area_of_Circle_func(current_Circle, 1));
...
int line_search(Circle_Array *current_Circle_Array, int number_of_Circles, float desired_value)
{
