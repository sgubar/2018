...
int menu1 ()
{
	...
	int i=0 , ch = 0, menulenght = 5, tmp = 0;
	COORD pos;
	...
	int positions[7][2] = {{0,2},{0,3},{0,4},{0,6},{0,7},{0,8}};
	...
	printf("-----------------\n");
	printf("  Bring out a tree (backwards type)!\n");
	...
	SetCharXY (positions[i][0], pos.Y + positions[i][1], ' ');
	SetCharXY (positions[0][0], positions[5][1]+tmp, ' ');
	printf("\n");
