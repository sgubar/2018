...
void SLSwapNodesByIndex(CharList *aList, int theLeft, int theRight)
{
    ...
    CharNode *theLeftNode = SLNodeAtIndex(aList, theLeft);
    CharNode *theRightNode = SLNodeAtIndex(aList, theRight);

	char theTmp = theLeftNode->value;
	theLeftNode->value = theRightNode->value;
	theRightNode->value = theTmp;

    /*CharNode *theNode_l,*theNode_r;
    theNode_r = SLNodeAtIndex(aList,theRight);
    theNode_l = SLNodeAtIndex(aList, theLeft);
    SLRemovedNodeAtIndex(aList, theRight);
    SLInsertNodeAtIndex(aList, theNode_l, theRight);
    SLRemovedNodeAtIndex(aList, theLeft);
    SLInsertNodeAtIndex(aList, theNode_r, theLeft);*/
}
